<?php
	...
	$table_exist = $conn->query("SELECT 1 FROM toptenenterprise");
	if( $table_exist == FALSE)
	{
		$create = "CREATE TABLE toptenenterprise (
	...
	{
		$conn->query("TRUNCATE TABLE toptenenterprise");
	}
    ...
    $worksheetTitle = 'Top10Enterprise'; // it's generally named 'Sheet1' 
    ...
    $sql = rtrim($sql,",");
    $insert = "INSERT INTO toptenenterprise(id,companyname,investors,sector,amount,city) VALUES" . $sql ;
    $conn->query($insert);
    $conn->close();
