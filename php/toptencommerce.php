<?php
	...
	$table_exist = $conn->query("SELECT 1 FROM toptencommerce");
	if( $table_exist == FALSE)
	{
		$create = "CREATE TABLE toptencommerce (
	...
	{
		$conn->query("TRUNCATE TABLE toptencommerce");
	}
    ...
    $worksheetTitle = 'Top10Commerce'; // it's generally named 'Sheet1' 
    ...
    $sql = rtrim($sql,",");
    $insert = "INSERT INTO toptencommerce(id,companyname,investors,sector,amount,city) VALUES" . $sql ;
    $conn->query($insert);
    $conn->close();
