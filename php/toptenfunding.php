<?php
	...
	$table_exist = $conn->query("SELECT 1 FROM toptenfunding");
	if( $table_exist == FALSE)
	{
		$create = "CREATE TABLE toptenfunding (
	...
	{
		$conn->query("TRUNCATE TABLE toptenfunding");
	}
    ...
    $worksheetTitle = 'Top10Funding'; // it's generally named 'Sheet1' 
    ...
    $sql = rtrim($sql,",");
    $insert = "INSERT INTO toptenfunding(id,companyname,investors,sector,amount,city) VALUES" . $sql ;
    $conn->query($insert);
    $conn->close();
